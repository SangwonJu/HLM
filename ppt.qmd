...
-   Overall Model Example: (intercept + fixed + random)
    ...
    - $MATHCH_{ij} = \underline{\beta_{0j} + \gamma_{00}} + $ 
  
    - $\underline{\gamma_{01}(SECTOR_{j}) + \gamma_{10}(SES_{ij}) +\gamma_{11} (SECTOR_j)(SES_{ij})}$
  
    - $\underline{u_{1j}(SES_{ij}) + u_{0j} + \epsilon_{ij}} $
